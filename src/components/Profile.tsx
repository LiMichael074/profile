...
const Profile = ({ pic_url, bio }: PorfileProps) => {
  return (
    <>
      <div className="grid-container">
        <img src={pic_url} className="profile_pic item_image"></img>
        <h1 className="item_header">Shau Ching Michael Li</h1>
        <h2 className="item_header2">
          3D Artist | Full-Stack Developer | Game Developer
        </h2>
        <div className="item_body">
          {/* I'm a detail oriented 3D Artist / Full-Stack Developer / Game
